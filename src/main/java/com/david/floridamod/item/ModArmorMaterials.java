...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> GATOR_ARMOR_MATERIAL = register("gator_hide", Util.make(new EnumMap<>(ArmorItem.Type.class),
        attribute -> {
    ...
    {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(FloridaMod.MOD_ID, name);
